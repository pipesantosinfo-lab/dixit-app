...
/* Entrada ligera y orgánica para tarjetas de redes sociales:
 * solo opacity + translateY → operaciones puras de GPU, sin blur ni rotate */
const stagger3D = {
  hidden:  {},
      ...
      <section ref={socialRef} data-track-section="social" className="relative z-10 px-6 md:px-12 py-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto">
          ...
          >
            ...
            {/* TikTok — entra desde la izquierda */}
            <motion.div variants={socialCardEntryLeft} className="glass rounded-2xl p-6 md:p-8 flex flex-col items-center text-center group hover:border-white/20 transition-all social-card-3d" style={{ transformStyle: 'preserve-3d' }}>
            ...
            {/* Instagram — sube desde abajo (al centro) */}
            <motion.div variants={socialCardEntryCenter} className="glass rounded-2xl p-6 md:p-8 flex flex-col items-center text-center group hover:border-white/20 transition-all relative social-card-3d" style={{ overflow: 'visible', transformStyle: 'preserve-3d' }}>
              <div className="w-14 h-14 rounded-2xl flex items-center justify-center mb-5" style={{ background: 'rgba(255,255,255,0.06)' }}>
                <svg width="28" height="28" viewBox="0 0 24 24" fill="white">
            ...
            {/* Facebook — entra desde la derecha */}
            <motion.div variants={socialCardEntryRight} className="glass rounded-2xl p-6 md:p-8 flex flex-col items-center text-center group hover:border-white/20 transition-all social-card-3d" style={{ transformStyle: 'preserve-3d' }}>
              <div className="w-14 h-14 rounded-2xl flex items-center justify-center mb-5" style={{ background: 'rgba(255,255,255,0.06)' }}>
                <svg width="28" height="28" viewBox="0 0 24 24" fill="white">
