      ...
      <section ref={socialRef} data-track-section="social" className="relative z-10 px-6 md:px-12 py-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            {/* TikTok */}
            <ScrollScale className="glass rounded-2xl p-6 md:p-8 flex flex-col items-center text-center group hover:border-white/20 transition-all social-card-3d">
            ...
            {/* Instagram */}
            <ScrollScale className="glass rounded-2xl p-6 md:p-8 flex flex-col items-center text-center group hover:border-white/20 transition-all relative social-card-3d" style={{ overflow: 'visible' }}>
              <div className="w-14 h-14 rounded-2xl flex items-center justify-center mb-5" style={{ background: 'rgba(255,255,255,0.06)' }}>
                <svg width="28" height="28" viewBox="0 0 24 24" fill="white">
