...
/* Entrada con spring físico — natural sin parpadeo. Solo opacity y translateY,
 * ambas en GPU. Spring se siente más orgánico que cualquier curva bezier
 * porque imita movimiento del mundo real. */
const stagger3D = {
  hidden:  {},
      ...
      <section ref={socialRef} data-track-section="social" className="relative z-10 px-6 md:px-12 py-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto">
          ...
          >
            ...
            {/* TikTok */}
            <motion.div variants={socialCardEntryLeft} className="glass rounded-2xl p-6 md:p-8 flex flex-col items-center text-center group hover:border-white/20 transition-all social-card-3d">
              <motion.div
            ...
            {/* Instagram */}
            <motion.div variants={socialCardEntryCenter} className="glass rounded-2xl p-6 md:p-8 flex flex-col items-center text-center group hover:border-white/20 transition-all relative social-card-3d" style={{ overflow: 'visible' }}>
              <motion.div
                className="flex flex-col items-center text-center w-full"
                animate={{ y: [0, -2.5, 0] }}
            ...
            {/* Facebook */}
            <motion.div variants={socialCardEntryRight} className="glass rounded-2xl p-6 md:p-8 flex flex-col items-center text-center group hover:border-white/20 transition-all social-card-3d">
              <motion.div
                className="flex flex-col items-center text-center w-full"
                animate={{ y: [0, -2.5, 0] }}
                transition={{ duration: 6.3, repeat: Infinity, ease: 'easeInOut', delay: 1.4 }}
              >
              <div className="w-14 h-14 rounded-2xl flex items-center justify-center mb-5" style={{ background: 'rgba(255,255,255,0.06)' }}>
                <svg width="28" height="28" viewBox="0 0 24 24" fill="white">
